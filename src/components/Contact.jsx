      ...
      <div className="space-y-4">
        <div className="border-1 border-gray-300 rounded-2xl p-4">
          <div className="flex flex-row gap-2 items-center">
              <img className="h-4 w-4 " src="./public/icons/email.png" alt="" />
        ...
        <div className="border-1 border-gray-300 rounded-2xl p-4">
            <div className="flex flex-row gap-2 items-center">
              <img className="h-4 w-4 " src="./public/icons/phone.png" alt="" />
              <p className="text-xs text-gray-600 font-medium mb-1">Contact Number: </p>
          </div>          <p className="text-gray-700 font-medium">09958493756</p>
        </div>
      </div>
    </div>
  </motion.div>
